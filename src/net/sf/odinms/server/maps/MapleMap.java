...
public class MapleMap {
    ...
    private List<Pair<PeriodicMonsterDrop, ScheduledFuture<?>>> periodicMonsterDrops = new ArrayList<>(2);
    ...
    public void shuffleReactors() {
        ...
        synchronized (this.mapobjects) {
            Iterator<MapleMapObject> mmoiter1 = this.mapobjects.values().iterator();
            ...
            Iterator<MapleMapObject> mmoiter2 = this.mapobjects.values().iterator();
        ...
        synchronized (mapobjects) {
            spawnAndAddRangedMapObject(monster, c -> {
                ...
                if (monster.getId() == 9300166) {
                    ...
                    startPeriodicMonsterDrop(monster.getController() != null ? monster.getController() : (MapleCharacter) getAllPlayers().get(0), monster, 1000, 100000);
                }
            }, null);
            updateMonsterController(monster);
        }
    ...
    protected void cancelPeriodicMonsterDrop(final PeriodicMonsterDrop pmd) {
